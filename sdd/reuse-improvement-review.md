...
- [x] Before publication review: proven reusable rules were staged in the kit and synchronized into this working copy; the current Docker benchmark is now persisted; the three-run median and raw lifecycle evidence are now persisted.
