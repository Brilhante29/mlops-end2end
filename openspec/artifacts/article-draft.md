# #21 mlops-end2end: time_to_production_seconds_median = pending seconds
...
The benchmark is the proof. time_to_production_seconds_median = pending seconds.  The result is stored in `benchmarks/results/summary.json` and can be reproduced from the Docker/local path.
